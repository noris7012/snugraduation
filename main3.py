...
xy_raw = np.loadtxt('data_mul2.csv', delimiter=',', dtype=np.float32)
...
print ("len", len(y_test), "sum:", (s_0+s_1+s_2+s_3+s_4), "acc:", float(s_0+s_1+s_2+s_3+s_4+s_5)/(cnt_0+cnt_1+cnt_2+cnt_3+cnt_4+cnt_5)) 
